            ...
            <div className="mb-2 grid gap-2 sm:grid-cols-2">
              {comparison.supplierTotals.slice(0, 2).map((supplier) => (
                <button
                  ...
                  type="button"
                  className="motion-lift flex items-center justify-between border border-slate-200 bg-white px-3 py-2 text-left text-xs active:scale-[0.99]"
                  onClick={() =>
                    onInspectRows(
            ...
            return (
              ...
              >
                ...
                <td className="whitespace-nowrap px-3 py-2 text-right">
                  <span className={`inline-flex min-w-14 justify-center px-2 py-1 text-xs font-semibold ${risk.className}`}>
                    {risk.label}
                  </span>
                </td>
