...
export const MATERIAL_KNOWLEDGE_RULES: MaterialKnowledgeRule[] = [
  { canonicalName: "吊钟组", category: "吊钟组", aliases: ["吊钟组", "吊钟", "吊盅", "吊盅组", "canopy"], ignoreSpec: true },
  { canonicalName: "吊杆组", category: "吊杆组", aliases: ["吊杆组", "吊杆", "吊管", "吊杆组5寸", "吊杆组8寸", "downrod"], ignoreSpec: true },
  { canonicalName: "灯盘组", category: "灯盘组", aliases: ["灯盘组", "灯盘", "底盘", "吸顶盘", "安装盘", "ceiling pan"], ignoreSpec: true },
  ...
  { canonicalName: "遥控器", category: "电子料", aliases: ["遥控器", "遥控", "遥控手柄", "remote control", "remote"], ignoreSpec: false },
  { canonicalName: "接收器", category: "电子料", aliases: ["接收器", "接收头", "接收板", "receiver"], ignoreSpec: false },
  { canonicalName: "PCB/电路板", category: "电子料", aliases: ["pcb", "pcba", "电路板", "线路板", "铝基板", "基板"], ignoreSpec: false },
  { canonicalName: "端子排/端子座", category: "端子排/端子座", aliases: ["端子排", "端子座", "接线端子", "terminal"], ignoreSpec: true },
  ...
  { canonicalName: "连接器", category: "电子料", aliases: ["连接器", "接插件", "插座", "插头", "connector", "conn"], ignoreSpec: false },
  { canonicalName: "电容", category: "电子料", aliases: ["电容", "capacitor", "cap"], ignoreSpec: false },
  { canonicalName: "电阻", category: "电子料", aliases: ["电阻", "resistor", "res"], ignoreSpec: false },
  { canonicalName: "IC/芯片", category: "电子料", aliases: ["ic", "芯片", "mcu", "chip"], ignoreSpec: false },
  ...
  { canonicalName: "包装袋", category: "包装袋", aliases: ["包装袋", "塑胶袋", "胶袋", "po袋", "p.o袋", "pe袋", "p.e袋", "bag"], ignoreSpec: true },
  ...
  { canonicalName: "说明书", category: "说明书", aliases: ["说明书", "说明书组", "manual", "instruction"], ignoreSpec: true },
...
const CATEGORY_ALIASES: Record<string, string[]> = {
  ...
  电子料: ["电子", "电子料", "pcb", "pcba", "电路"],
  光源: ["光源", "光电", "灯珠", "led", "cob", "透镜", "扩散"],
  "驱动/控制器": ["驱动", "控制器", "控制", "米家天线", "天线"],
