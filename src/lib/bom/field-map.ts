...
const aliases: Record<BomFieldKey, string[]> = {
  ...
  spec: ["spec", "specification", "model", "型号", "规格", "规格型号", "规格/型号", "型号规格", "描述"],
  category: ["category", "type", "class", "品类", "类别", "分类", "物料类别", "材料类别", "主要构成部分", "构成部分"],
  unit: ["unit", "uom", "单位", "计量单位"],
  quantity: ["qty", "quantity", "usage", "用量", "数量", "数量/套", "用量/套", "需求数量", "单套用量"],
  unitPrice: [
    "unit price",
    "price",
    "quote",
  ...
  amount: ["amount", "total", "total price", "subtotal", "金额", "总价", "合计", "小计", "总金额", "报价金额"],
